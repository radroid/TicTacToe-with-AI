...
public class GameBoard {
    ...
    private int[] previousMoveX = new int[2];
    private int[] previousMoveO = new int[2];
    private int[][] availableCells;
    private int playableMoves = 9;
    ...
    public void playMove(int[] coordinates) {
        ...
        if (xNum <= oNum) {
            this.previousMoveX = coordinates;
        } else {
            this.previousMoveO = coordinates;
        }
    ...
    public int[] getPreviousMoveO() {
        return previousMoveO;
    }

    public int[] getPreviousMoveX() {
